...
<table width="780" border="0" cellspacing="0" cellpadding="0" height="60" align="left" name="top_table">
	<tbody valign="top" align="left">
		<tr valign="bottom" align="left"> 
			<td border="0" width="50" height="50" rowspan="2">
			<a href="../main/index.jsp"><img name="Image5" border="0" src="../img/logo_12.gif" width="350" height="60"></a></td>
			<td>&nbsp;</td>
...
<%
			if( session.getAttribute("pid") != null) {
%>
			<td><a href="../member/logout.jsp" class=line>[ 로그아웃 ]</a></td>
<%
			}  else {
%>
